    ...
    <section>
      <div className="w-full justify-between flex pl-[10%] pr-[10%] pt-[3%] ">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-white">Phone: +993 64550330</p>
          <p className="text-white">Email: info@bimakstm.com</p>
          <p className="text-white">Fax: +993 64550330</p>
        </div>
        <div className="flex flex-col gap-2">
          <h1 className="text-white text-2xl">Location</h1>
          <p className="text-white">
            10 yil Abadanchiliq Highway, <br /> 137, Ашхабад
          </p>
        </div>
      </div>
