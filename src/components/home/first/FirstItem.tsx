  ...
  return (
    <div className="mt-10 mb-10">
      <div className="flex flex-col">
        <h1 className="text-[30px] font-[600]">MAKS GAZ TURBIN TEMIZLEYCHI</h1>
          ...
          <div className="flex flex-col gap-5">
            ...
            <h1 className="font-[600]">
              ...
              <span className="font-thin">
                gaz türbinlerinin temizlenmesi ve korozyonun engellenmesi için
                tasarlanmış konsantre, nötr temizleme sıvısıdır. Tehlikesiz, su
                bazlı ve biyolojik olarak parçalanabilir olup; korozif, yanıcı
                ve toksik olmayan Gaz Türbin Kompresör temizleyicidir.
              </span>
            </h1>
          </div>
        </div>
